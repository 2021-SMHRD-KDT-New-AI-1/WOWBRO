...
public class Course3Adapter extends BaseAdapter {
    ...
    private int layout;
    private List<com.jkh.wowbro2.Course3VO> data;

    private LayoutInflater inflater;

    public Course3Adapter(Context context, int layout, List<com.jkh.wowbro2.Course3VO> data){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        img_clear2.setColorFilter(Color.parseColor("#EF9A9A"));
